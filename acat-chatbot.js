...
(function () {
  ...
  const FAQ = [
    { keys: ["what is acat", "about acat", "who are you"],
    ...
    { keys: ["report", "complaint", "scam", "fraud", "hacked"],
      a: "To report a cyber incident, please use the contact/report section on our website, or reach out to National Cyber Crime Helpline 1930 / cybercrime.gov.in for official complaints." },
    { keys: ["join", "volunteer", "member", "team"],
    ...
    { keys: ["cto", "sourav", "technical"],
      a: "Sourav Maity is the CTO of ACAT, handling the tech and website side of things." },
    { keys: ["donate", "donation", "psf", "support"],
    ...
    { keys: ["awareness", "workshop", "training", "school"],
    ...
    { keys: ["hi", "hello", "hey", "namaste"],
      a: "Hey! 👋 I'm the ACAT assistant. Ask me about our mission, reporting cybercrime, joining as a volunteer, or how to reach us." },
  ];
  ...
  const QUICK_REPLIES = ["What is ACAT?", "How to report a scam?", "How to join as volunteer?", "Contact info"];
